...
print("Starting high-quality optimization. This will take a few minutes...")
...
final_img.save("Final_Result.jfif")
print("Done! High-quality image saved as Final_Result.jfif")